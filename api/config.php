<?php
// api/config.php - TutorLink Dual MySQL / SQLite Database Configuration
...
try {
    // Primary: Attempt connection to XAMPP MySQL
...
$autoIncrementSyntax = $is_mysql ? "AUTO_INCREMENT" : "AUTOINCREMENT";
$pdo->exec("
